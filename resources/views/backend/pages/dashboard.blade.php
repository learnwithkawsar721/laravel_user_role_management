                                ...
                                <table class="dbkit-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="buy">30% <img
                                                ...
                                                alt="icon"></td>
                                        <td class="sell">20% <img
                                                src="{{ asset('backend') }}/assets/images/icon/market-value/triangle-up.png" alt="icon"></td>
                                        <td class="trends"><img
                    ...
                    <div class="card-body">
                        ...
                        <div class="letest-news mt-5">
                            <div class="single-post mb-xs-40 mb-sm-40">
                                <div class="lts-thumb">
                                    <img src="{{ asset('backend') }}/assets/images/blog/post-thumb1.jpg"
                                        alt="post thumb">
                                </div>
                            ...
                            <div class="single-post">
                                <div class="lts-thumb">
                                    <img src="{{ asset('backend') }}/assets/images/blog/post-thumb2.jpg"
                                        alt="post thumb">
                                </div>
                                <div class="lts-content">
                                    <span>Admin Post</span>
